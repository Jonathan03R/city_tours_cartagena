...
class _AgenciasSeccionState extends State<AgenciasSeccion> {
  ...
  void _navigateToAgenciaReservas(int codigoAgencia, String? nombreAgencia) {
    // Obtener la instancia ya creada en el árbol (no crear una nueva)
    final deltaController = Provider.of<ControladorDeltaReservas>(
      context,
      listen: false,
    );
